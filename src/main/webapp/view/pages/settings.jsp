        ...
        <main class="pt-24 pb-12 min-h-screen">
          <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <c:if test="${not empty successMessage}">
              <div
                class="mb-6 p-4 rounded-xl bg-green-50 border border-green-100 text-green-700 flex items-center gap-2">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <div class="toggle-wrapper cursor-pointer" data-target="noticeAlert">
                      <input type="checkbox" name="noticeAlert" id="noticeAlert" class="hidden"
                        ${user.noticeAlertEnabled ? 'checked' : '' }>
                      <div
                        class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${user.noticeAlertEnabled ? 'bg-primary' : 'bg-gray-200'}">
                        <span
                          class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${user.noticeAlertEnabled ? 'translate-x-6' : 'translate-x-1'}"></span>
                      </div>
                    </div>
                  </div>
