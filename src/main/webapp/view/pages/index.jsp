          ...
          <section class="py-24 bg-gray-900 text-white overflow-hidden">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div class="flex flex-col md:flex-row-reverse items-center gap-16">
                <div class="w-full md:w-1/2 reveal">
                  <div
                    class="inline-block px-4 py-1 rounded-full bg-red-500/20 text-red-300 font-semibold text-sm mb-6">
          ...
          <section class="py-24 overflow-hidden bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div class="flex flex-col md:flex-row items-center gap-16">
                <div class="w-full md:w-1/2 reveal">
                  <div
                    class="inline-block px-4 py-1 rounded-full bg-green-100 text-green-600 font-semibold text-sm mb-6">
                    Course Review</div>
                  <h3 class="text-4xl md:text-5xl font-bold text-dark mb-6 leading-tight">
                    실패 없는 수강신청,<br>
          ...
          <%-- <!-- Bottom CTA Section -->--%>
            <%-- <section class="py-20 bg-primary relative overflow-hidden">--%>
              <%-- <div class="absolute inset-0">--%>
                <%-- <div
                  class="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-primary to-blue-600 opacity-90">
                  </div>--%>
                  <%-- <div--%>
                    <%--
