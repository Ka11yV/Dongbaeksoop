...
<body class="antialiased">
    ...
    <main class="pt-24 pb-12 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex p-1 space-x-1 bg-gray-100 rounded-xl">
                <button id="tab-profile" onclick="switchTab('profile')" class="w-full py-2.5 text-sm font-bold leading-5 text-primary bg-white rounded-lg shadow transition-all">
                    프로필
                </button>
                <button id="tab-reviews" onclick="switchTab('reviews')" class="w-full py-2.5 text-sm font-medium leading-5 text-gray-500 rounded-lg hover:text-gray-700 hover:bg-white/50 transition-all">
                    내 평가
                </button>
                <button id="tab-account" onclick="switchTab('account')" class="w-full py-2.5 text-sm font-medium leading-5 text-gray-500 rounded-lg hover:text-gray-700 hover:bg-white/50 transition-all">
                    학교 계정 연동
                </button>
            </div>
            ...
            <div id="section-profile" class="flex flex-col gap-6">
                <div class="flex flex-col md:flex-row items-center md:items-start gap-6 p-8 rounded-2xl bg-white border border-gray-100 shadow-sm">
                    <div class="relative">
                        <div class="h-24 w-24 rounded-full bg-blue-50 flex items-center justify-center text-primary text-3xl font-bold border-4 border-white shadow-md">
                    ...
                    <div class="text-center md:text-left flex-1">
                        <h2 class="text-2xl font-bold text-dark mb-1">${user.userId}</h2>
                        <p class="text-gray-500 mb-4">${user.email}</p>
                        <div class="flex items-center justify-center md:justify-start gap-2">
                            <span class="px-3 py-1 rounded-full bg-gray-100 text-xs font-bold text-gray-600">${user.deptName}</span>
                            <span class="px-3 py-1 rounded-full bg-gray-100 text-xs font-bold text-gray-600">${user.grade}학년</span>
                        </div>
                    </div>

                    <div class="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-xl min-w-[120px]">
                        <span class="text-3xl font-bold text-primary mb-1">12</span>
                        <span class="text-sm font-medium text-blue-600">작성한 평가</span>
                    </div>
                </div>

                <div class="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm" id="myInfo">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between w-full h-12 px-4 bg-gray-50 rounded-xl border border-gray-200 text-gray-500">
                                <span id="deptName">${user.deptName}</span>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between w-full h-12 px-4 bg-gray-50 rounded-xl border border-gray-200 text-gray-500">
                                <span id="grade">${sessionScope.loggedInUser.grade}학년</span>
                                <svg class="w-5 h-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                </svg>
                ...
                <div class="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm hidden" id="editDeptGrade">
                    <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
                        <h3 class="text-lg font-bold text-dark">프로필 정보</h3>
            ...
            <div id="section-account" class="hidden space-y-6">
                        ...
                        <div class="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm">
                            ...
                            <div class="space-y-6">
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <input type="password" placeholder="비밀번호를 입력하세요" class="w-full h-12 px-4 bg-gray-50 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all placeholder-gray-400">
                    ...
                    <div id="account-linked" class="hidden">
                        <div class="p-6 mb-8 bg-green-50 border border-green-100 rounded-2xl flex items-center gap-4">
                        ...
                        <div class="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm">
                            ...
                            <button onclick="toggleAccountLink()" class="w-full h-12 border border-rose-200 text-rose-500 hover:bg-rose-50 font-bold rounded-xl transition-all">
                                연동 해제
                            </button>
                        </div>
                    </div>
    ...
    <script>const contextPath = '${pageContext.request.contextPath}/my-page';</script>
