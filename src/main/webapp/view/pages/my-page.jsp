                    ...
                    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <%--프로필--%>
                            <div id="section-profile" class="flex flex-col gap-6">
                                <div
                                    ...
                                    <div class="text-center md:text-left flex-1">
                                        ...
                                        <div class="flex items-center justify-center md:justify-start gap-2">
                                            <span
                                                class="px-3 py-1 rounded-full bg-gray-100 text-xs font-bold text-gray-600">${user.deptName}</span>
                                            <span
                                                class="px-3 py-1 rounded-full bg-gray-100 text-xs font-bold text-gray-600">${user.grade}학년</span>
                                        </div>
                                    </div>
                                ...
                                <div class="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm hidden"
                                    id="editDeptGrade">
                                    <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
                                        <h3 class="text-lg font-bold text-dark">프로필 정보</h3>
                            ...
                            <div id="section-reviews" class="hidden">
                                <div
                                    class="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm text-center py-20">
                                    <div
                            ...
                            <div id="section-account" class="hidden space-y-6">
                                ...
                                <div id="account-not-linked">
                                    <div
                                        ...
                                        <p class="text-sm font-medium text-blue-800">학교 포털 계정을 연동하면 수강 과목의 과제를 자동으로 불러올
                                            수 있습니다.
                                        </p>
                                    </div>
