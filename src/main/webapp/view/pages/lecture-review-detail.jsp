            ...
            <body class="antialiased">
                ...
                <%@ include file="/view/common/header.jsp" %>
                        ...
                        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="flex flex-col lg:flex-row gap-8">
                                ...
                                <div class="lg:w-1/3 space-y-6">
                                    ...
                                    <div
                                        class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 sticky top-24">
                                        <!-- Lecture Header -->
                                        <div class="mb-6">
                                            <span
                                                class="inline-block px-2.5 py-1 rounded-lg bg-blue-50 text-primary text-xs font-bold mb-2">${lectureInfoDTO.courseType}</span>
                                            <h1 class="text-2xl font-bold text-dark mb-1">${lectureInfoDTO.lectureName}
                                            </h1>
                                        ...
                                        <c:if test="${empty requestScope.emptyReview}">
                                            <div class="text-center mb-8">
                                                <div class="flex items-end justify-center gap-1 mb-2">
                                                    <span
                                                        class="text-5xl font-bold text-primary">${reviewSummaryDTO.avgRating}</span>
                                                ...
                                                <div class="flex justify-center gap-1 text-yellow-400 mb-2">
                                                    <c:set var="roundedRating"
                                                        value="${Math.floor(reviewSummaryDTO.avgRating)}" />
                                                    <c:forEach begin="1" end="5" var="i">
                                                        <svg class="w-5 h-5 fill-current ${i <= roundedRating ? 'text-yellow-400' : 'text-gray-300'}"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                ...
                                                <p class="text-sm text-gray-500">${reviewSummaryDTO.countReview}개의 리뷰
                                                </p>
                                            </div>
                                            ...
                                            <div class="space-y-2 mb-8">
                                                ...
                                                <c:choose>
                                                    <c:when test="${totalReviews > 0}">
                                                        <c:set var="percent5star"
                                                            value="${(reviewSummaryDTO.count5star / totalReviews) * 100}" />
                                                        <c:set var="percent4star"
                                                            value="${(reviewSummaryDTO.count4star / totalReviews) * 100}" />
                                                        <c:set var="percent3star"
                                                            value="${(reviewSummaryDTO.count3star / totalReviews) * 100}" />
                                                        <c:set var="percent2star"
                                                            value="${(reviewSummaryDTO.count2star / totalReviews) * 100}" />
                                                        <c:set var="percent1star"
                                                            value="${(reviewSummaryDTO.count1star / totalReviews) * 100}" />
                                                    </c:when>
                                                    <c:otherwise>
                                                ...
                                                <div class="flex items-center gap-3 text-sm">
                                                    ...
                                                    <div class="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                                                        <div class="h-full bg-primary rounded-full"
                                                            style="width: <fmt:formatNumber value=" ${percent5star}"
                                                            maxFractionDigits="0" />%">
                                                    </div>
                                                </div>
                                                <span
                                                    class="w-6 text-right text-gray-400">${reviewSummaryDTO.count5star}</span>
                                            </div>
                                            ...
                                            <div class="flex items-center gap-3 text-sm">
                                                ...
                                                <div class="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                                                    <div class="h-full bg-primary rounded-full"
                                                        style="width: <fmt:formatNumber value=" ${percent4star}"
                                                        maxFractionDigits="0" />%">
                                                </div>
                                            </div>
                                            <span
                                                class="w-6 text-right text-gray-400">${reviewSummaryDTO.count4star}</span>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-3 text-sm">
                                        ...
                                        <div class="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                                            <div class="h-full bg-primary rounded-full"
                                                style="width: <fmt:formatNumber value=" ${percent3star}"
                                                maxFractionDigits="0" />%">
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center gap-3 text-sm">
                                    ...
                                    <div class="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                                        <div class="h-full bg-primary rounded-full"
                                            style="width: <fmt:formatNumber value=" ${percent2star}"
                                            maxFractionDigits="0" />%">
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center gap-3 text-sm">
                                ...
                                <div class="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                                    <div class="h-full bg-primary rounded-full" style="width: <fmt:formatNumber value="
                                        ${percent1star}" maxFractionDigits="0" />%">
                                </div>
                            </div>
                                        ...
                                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                                            <div class="flex justify-between items-start mb-4">
                                                <div class="flex items-center gap-2">
                                                    <div class="flex">
                                                        <svg class="w-5 h-5 fill-current ${review.rating >= 1 ? 'text-yellow-400' : 'text-gray-300'}"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                        </svg>
                                                        <svg class="w-5 h-5 fill-current ${review.rating >= 2 ? 'text-yellow-400' : 'text-gray-300'}"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                        </svg>
                                                        <svg class="w-5 h-5 fill-current ${review.rating >= 3 ? 'text-yellow-400' : 'text-gray-300'}"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                        </svg>
                                                        <svg class="w-5 h-5 fill-current ${review.rating >= 4 ? 'text-yellow-400' : 'text-gray-300'}"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                        </svg>
                                                        <svg class="w-5 h-5 fill-current ${review.rating >= 5 ? 'text-yellow-400' : 'text-gray-300'}"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                        </svg>
                                                    ...
                                                    <span class="font-bold text-primary text-lg"
                                                        id="rating">${review.rating}.0</span>
                                            ...
                                            <div class="flex flex-wrap gap-2 mb-6">
                                                <span
                                                    class="px-3 py-1.5 rounded-lg bg-blue-50 text-primary text-xs font-bold">${review.difficulty}</span>
                                                <span
                                                    class="px-3 py-1.5 rounded-lg bg-blue-50 text-primary text-xs font-bold">${review.workload}</span>
                                                <span
                                                    class="px-3 py-1.5 rounded-lg bg-blue-50 text-primary text-xs font-bold">${review.teamProject}</span>
                                                <span
                                                    class="px-3 py-1.5 rounded-lg bg-blue-50 text-primary text-xs font-bold">${review.attendanceMethod}</span>
                                            </div>
                            ...
                            <form class="space-y-2" action="/lecture-review-detail" method="post">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input id="course-semester-input" value="2025-2" name="courseSemester"
                                            class="hidden" />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="workload-input" value="default" name="workload"
                                            class="hidden" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="team-project-input" value="default" name="teamProject"
                                            class="hidden" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="attendance-method-input" value="default"
                                            name="attendanceMethod" class="hidden" />
                                    </div>
                                </div>
                                ...
                                <input type="text" value="${lectureInfoDTO.lectureId}" name="lectureId"
                                    class="hidden" />
                                <input type="text" value="${lectureInfoDTO.professorId}" name="professorId"
                                    class="hidden" />
                    ...
                    <%@ include file="/view/common/footer.jsp" %>
                        ...
                        <script
                            src="${pageContext.request.contextPath}/assets/scripts/lecture-review-detail.js?v=<%=new java.util.Date().getTime()%>"></script>
            </body>
