                        ...
                        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="mb-8 w-full rounded-2xl bg-white p-6 shadow-lg border border-gray-100">
                                <div class="relative mb-6 w-full">
                                    <input type="text" placeholder="강의명 또는 교수명 검색..." id="searchKeywordInput"
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <div class="relative inline-block">
                                        <select id="deptSelect" autocomplete="off"
                                            ...
                                            <div class="flex flex-wrap items-center gap-x-3 text-sm text-gray-500 mt-1">
                                                ...
                                                <span class="flex items-center gap-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                                        viewBox="0 2 20 20">
                                                        <path fill="none" stroke="#98A1B0" stroke-linecap="round"
                                            ...
                                            <div class="flex flex-col items-end gap-1">
                                                <div class="flex items-center gap-1 text-yellow-400">
                                                    <c:set var="roundedRating"
                                                        value="${Math.floor(lecture.reviewSummaryDTO.avgRating)}" />
                                                ...
                                                <div class="flex items-baseline text-right">
                                                    ...
                                                    <span class="text-lg font-bold text-dark">
                                                        <fmt:formatNumber value="${lecture.reviewSummaryDTO.avgRating}"
                                                            pattern="0.0" />
                                                    </span>
