        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><a href="${pageContext.request.contextPath}/notifications" class="hover:text-primary transition-colors">공지사항</a></li>
                    <li><a href="${pageContext.request.contextPath}/assignments" class="hover:text-primary transition-colors">과제 알림</a></li>
                    <li><a href="${pageContext.request.contextPath}/lecture-reviews" class="hover:text-primary transition-colors">강의 평가</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><a href="https://www.dongyang.ac.kr" target="_blank" class="hover:text-primary transition-colors">동양미래대학교</a></li>
                    <li><a href="https://portal.dongyang.ac.kr" target="_blank" class="hover:text-primary transition-colors">포털 시스템</a></li>
                    <li><a href="https://lib.dongyang.ac.kr" target="_blank" class="hover:text-primary transition-colors">도서관</a></li>
                </ul>
            </div>
        </div>
