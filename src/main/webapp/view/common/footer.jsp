    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 lg:gap-24">
            ...
            <div class="col-span-2 md:col-span-1 flex flex-col space-y-4">
                <div class="flex items-center space-x-2">
                    <h3 class="text-primary text-2xl font-extrabold tracking-tight text-white">동백숲</h3>
                </div>
                <div class="text-gray-400 text-sm font-light space-y-1">
                    <p>동양미래대 학생들을 위한</p>
                    <p>강의 평가 및 맞춤형 공지 알림 서비스</p>
                    <p class="pt-2 text-xs text-gray-500">Service for Dongyang Mirae University students.</p>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="${pageContext.request.contextPath}/notifications"
                           class="text-gray-400 hover:text-primary transition-colors">공지사항</a></li>
                    <li><a href="${pageContext.request.contextPath}/notice-subscription-management"
                           class="text-gray-400 hover:text-primary transition-colors">공지 구독</a></li>
                    <li><a href="${pageContext.request.contextPath}/assignments"
                           class="text-gray-400 hover:text-primary transition-colors">과제 알림</a></li>
                    <li><a href="${pageContext.request.contextPath}/lecture-reviews"
                           class="text-gray-400 hover:text-primary transition-colors">강의 평가</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">자주 묻는 질문 (FAQ)</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">문의하기</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">버그 제보</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="https://www.dongyang.ac.kr" target="_blank"
                           class="text-gray-400 hover:text-primary transition-colors">동양미래대학교</a></li>
                    <li><a href="https://portal.dongyang.ac.kr" target="_blank"
                           class="text-gray-400 hover:text-primary transition-colors">포털 시스템</a></li>
                    <li><a href="https://lib.dongyang.ac.kr" target="_blank"
                           class="text-gray-400 hover:text-primary transition-colors">도서관</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="mt-12 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <p class="text-gray-500 text-sm mb-4 md:mb-0">
                &copy; 2024 동백숲. All rights reserved. | <a href="#" class="hover:text-gray-400">개인정보처리방침</a>
            </p>
