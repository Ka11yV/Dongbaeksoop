...
<body>
  ...
  <div class="bg-gray-50 min-h-screen" data-name="HomePage" data-node-id="149:1242">
    ...
    <div class="relative h-[364px] overflow-hidden w-full" data-name="Section" data-node-id="149:1391">
      ...
      <div class="relative z-10 flex flex-col gap-6 items-center justify-center h-full text-center px-4 max-w-4xl mx-auto" data-name="Container" data-node-id="149:1395">
        ...
        <div class="flex gap-4" data-name="Container" data-node-id="149:1400">
          <a href="#" class="bg-white rounded-lg px-6 py-2 flex items-center justify-center" data-name="Link" data-node-id="149:1401">
          ...
          <a href="#" class="bg-[rgba(0,98,173,0.9)] rounded-lg px-6 py-2 flex items-center justify-center" data-name="Link" data-node-id="149:1403">
    ...
    <!-- Section 1: Cards (Visually second) -->
    <div class="container mx-auto py-16 px-4" data-name="Section" data-node-id="149:1243">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white border-2 border-[rgba(0,0,0,0.1)] border-solid rounded-xl p-6 flex flex-col items-start hover:border-primary" data-name="Link" data-node-id="149:1244">
          ...
          <h2 class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-xl text-neutral-950 mb-2" data-node-id="149:1252">
            강의 평가
          </h2>
        ...
        <div class="bg-white border-2 border-[rgba(0,0,0,0.1)] border-solid rounded-xl p-6 flex flex-col items-start" data-name="Link" data-node-id="149:1255">
          ...
          <h2 class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-xl text-neutral-950 mb-2" data-node-id="149:1263">
            맞춤형 공지
          </h2>
        ...
        <div class="bg-white border-2 border-[rgba(0,0,0,0.1)] border-solid rounded-xl p-6 flex flex-col items-start" data-name="Link" data-node-id="149:1266">
          ...
          <h2 class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-xl text-neutral-950 mb-2" data-node-id="149:1278">
            과제 관리 & 알림
          </h2>
    ...
    <!-- Section 2: Latest Course Reviews (Visually third) -->
    <div class="container mx-auto py-16 px-4" data-name="Section" data-node-id="149:1281">
      <div class="flex justify-between items-center mb-8">
        ...
        <a href="#" class="text-[#0062ad] font-['Inter:Medium','Noto_Sans_KR:Regular',sans-serif] font-medium text-sm flex items-center gap-1" data-name="Link" data-node-id="149:1289">
          전체보기 &rarr;
        </a>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white border border-[rgba(0,0,0,0.1)] border-solid rounded-xl p-6 flex flex-col" data-name="Card" data-node-id="149:1292">
          <div class="flex justify-between items-start mb-2">
            <div>
              <h3 class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-base text-neutral-950" data-node-id="149:1297">
                웹 프로그래밍
              </h3>
              <p class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-sm text-[#4a5565]" data-node-id="149:1299">
                김교수
              </p>
            </div>
            <span class="bg-[#eceef2] rounded-lg px-2 py-1 text-xs font-['Inter:Medium','Noto_Sans_KR:Regular',sans-serif] font-medium text-[#030213]" data-node-id="149:1301">
              전공
            </span>
          </div>
          <div class="flex justify-between items-center mb-4">
            <div class="flex items-center gap-1" data-name="StarRating" data-node-id="149:1303">
              ...
              <p class="font-['Inter:Regular',sans-serif] font-normal text-sm text-[#4a5565]" data-node-id="149:1320">
                4.5
              </p>
            </div>
            <p class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-sm text-[#4a5565]" data-node-id="149:1322">
              난이도: 중
            </p>
          </div>
        ...
        <div class="bg-white border border-[rgba(0,0,0,0.1)] border-solid rounded-xl p-6 flex flex-col" data-name="Card" data-node-id="149:1325">
          <div class="flex justify-between items-start mb-2">
            <div>
              <h3 class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-base text-neutral-950" data-node-id="149:1330">
                데이터베이스
              </h3>
              <p class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-sm text-[#4a5565]" data-node-id="149:1332">
                이교수
              </p>
            </div>
            <span class="bg-[#eceef2] rounded-lg px-2 py-1 text-xs font-['Inter:Medium','Noto_Sans_KR:Regular',sans-serif] font-medium text-[#030213]" data-node-id="149:1334">
              전공
            </span>
          </div>
          <div class="flex justify-between items-center mb-4">
            <div class="flex items-center gap-1" data-name="StarRating" data-node-id="149:1336">
              ...
              <img alt="" class="w-4 h-4" src="https://www.figma.com/api/mcp/asset/1d45d47f-4044-4db6-8e46-3bc0aadb1b7f" />
              <img alt="" class="w-4 h-4" src="https://www.figma.com/api/mcp/asset/342765ce-7320-4862-9408-7c623a263959" />
              <p class="font-['Inter:Regular',sans-serif] font-normal text-sm text-[#4a5565]" data-node-id="149:1353">
                4.8
              </p>
            </div>
            <p class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-sm text-[#4a5565]" data-node-id="149:1355">
              난이도: 상
            </p>
          </div>
        ...
        <div class="bg-white border border-[rgba(0,0,0,0.1)] border-solid rounded-xl p-6 flex flex-col" data-name="Card" data-node-id="149:1358">
          <div class="flex justify-between items-start mb-2">
            <div>
              <h3 class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-base text-neutral-950" data-node-id="149:1363">
                영어회화
              </h3>
              <p class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-sm text-[#4a5565]" data-node-id="149:1365">
                박교수
              </p>
            </div>
            <span class="bg-[#eceef2] rounded-lg px-2 py-1 text-xs font-['Inter:Medium','Noto_Sans_KR:Regular',sans-serif] font-medium text-[#030213]" data-node-id="149:1367">
              교양
            </span>
          </div>
          <div class="flex justify-between items-center mb-4">
            <div class="flex items-center gap-1" data-name="StarRating" data-node-id="149:1369">
              ...
              <img alt="" class="w-4 h-4" src="https://www.figma.com/api/mcp/asset/1d45d47f-4044-4db6-8e46-3bc0aadb1b7f" />
              <img alt="" class="w-4 h-4" src="https://www.figma.com/api/mcp/asset/342765ce-7320-4862-9408-7c623a263959" />
              <p class="font-['Inter:Regular',sans-serif] font-normal text-sm text-[#4a5565]" data-node-id="149:1386">
                4.2
              </p>
            </div>
            <p class="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-sm text-[#4a5565]" data-node-id="149:1388">
              난이도: 하
            </p>
          </div>
